//
//  CMXEngageDeviceSubscriber.h
// CMXEngageSDK
//

#import "CMXEngageUserSubscriber.h"

@interface CMXEngageDeviceSubscriber : NSObject

@property(readonly, nonatomic, strong) CMXEngageUserSubscriber *associatedUserSubscriber;
...
- (void)associateUserWithIdentity:(NSString *)identity ofType:(NSString *)type onCompletion:(void (^)(CMXEngageUserSubscriber *userSubscriber, NSError *error))completionBlock;

- (void)associateWithUserSubscriber:(CMXEngageUserSubscriber *)user;
...
- (void)removeObjectsForKey:(NSString *)preferenceName value:(NSObject *)value shared:(BOOL)shared;
/*
